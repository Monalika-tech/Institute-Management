    ...
    <div className="flex flex-col sm:flex-row border border-gray-400">
      ...
      <div className=" w-full sm:w-1/2 flex flex-col items-center justify-center py-10 sm:py-10">
        ...
        <div className="flex flex-col  gap-6">
          <p className="font-semibold text-base"><strong> Name  </strong>  {teacher.name}</p>
          <p className="font-semibold text-base"><strong> Email  </strong>  {teacher.email}</p>
          <p className="font-semibold text-base"><strong>Phone no. </strong>  {teacher.phone_no}</p>
          <p className="font-semibold text-base"><strong> Address</strong>  {teacher.address}</p>
          <p className="font-semibold text-base"><strong> Experienced Years</strong>  {teacher.experiencedYears}</p>
          <p className="font-semibold text-base"><strong> Qualification</strong>  {teacher.qualification}</p>
        </div>
      </div>
